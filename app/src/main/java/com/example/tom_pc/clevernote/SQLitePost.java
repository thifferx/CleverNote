...
public class SQLitePost extends SQLiteOpenHelper {

    public SQLitePost(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void updateData(String name, String post, byte[] image, int id) {
        ...
        String sql = "UPDATE POST SET name = ?, post = ?, image = ? WHERE id = ?";
        SQLiteStatement statement = database.compileStatement(sql);
